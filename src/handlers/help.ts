...
const HELP =
  "🎁 Add me to a group and let an admin turn on gift draws. I’ll choose from members who chat while draws are on.\n\n" +
  "Admins can use the Gift draws button, or /enable, /disable, /chance 5, and /lastdraw.";
